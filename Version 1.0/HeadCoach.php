...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <input type="text" id="browse-content" placeholder="Browse the file from the dekstop" />
      ...
      <form method="post" action="testCode.php" enctype="multipart/form-data">
      ...
      <tbody>
        ...
        <tr>
          <td style="margin:0 auto; width:100%;">
            <span id="eventName">2017 Commerce Meet</span>
            <span style="width: 50%;float:right;margin-right:-15%;">
            <button type="button" class="btn btn-primary">View Events&nbsp;<i class="fa fa-calendar" style="color:white;"></i></button>
            &nbsp;&nbsp;
        ...
        <tr>
          <td style="margin:0 auto; width:100%;">
            <span id="eventName">2016 Commerce Meet</span>
            <span style="width: 50%;float:right;margin-right:-15%;">
            <button type="button" class="btn btn-primary">View Events&nbsp;<i class="fa fa-calendar" style="color:white;"></i></button>
            &nbsp;&nbsp;
            <button type="button" class="btn btn-primary">View Report&nbsp;<i class="fa fa-file-text" style="color:white;"></i></button>
        ...
        <tr>
          <td style="margin:0 auto; width:100%;margin-right:-15%;">
            <span id="eventName">Bellflower Meet</span>
            <span style="width: 50%;float:right;margin-right:-15%;">
            <button type="button" class="btn btn-primary">View Events&nbsp;<i class="fa fa-calendar" style="color:white;"></i></button>
            &nbsp;&nbsp;
            <button type="button" class="btn btn-primary">View Report&nbsp;<i class="fa fa-file-text" style="color:white;"></i></button>
        ...
        <tr>
          <td style="margin:0 auto; width:100%;margin-right:-15%;">
            <span id="eventName">Metro Champs Meet</span>
            <span style="width: 50%;float:right;margin-right:-15%;">
            <button type="button" class="btn btn-primary">View Events&nbsp;<i class="fa fa-calendar" style="color:white;"></i></button>
            &nbsp;&nbsp;
            <button type="button" class="btn btn-primary">View Report&nbsp;<i class="fa fa-file-text" style="color:white;"></i></button>
