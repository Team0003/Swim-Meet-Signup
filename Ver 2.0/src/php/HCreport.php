  ...
  <body>
      ...
      <div class="meetinfo">
        ...
        <div class="meetactions">
            <a href="createPDF.php?meetid=<?php echo $_SESSION['meetid']; ?>&deadline=<?php echo $_SESSION['deadline']; ?>&meetname=<?php echo $_SESSION['name']; ?>" target="_blank"><button>Generate Report</button></a>
        </div>
      </div>
       <div class="pagup">
        <ul class="pagination">
