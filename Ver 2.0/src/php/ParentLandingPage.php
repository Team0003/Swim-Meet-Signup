  ...
  <body ng-app="app" ng-controller="mainController as main">
      ...
      <div class="navbtns">
       ...
       // echo "<script>console.log('hey $result.length');</script>";  
	    ...
	    ?>
            <li><a id="<?php echo $counter ?>" ng-init="main.getMeetEvents(<?php echo $row[1]?>,'<?php echo $dob?>','<?php echo $sex?>','<?php echo $loginId?>',<?php echo $counter?>)" ng-click="main.getMeetEvents(<?php echo $row[1]?>,'<?php echo $dob?>','<?php echo $sex?>', '<?php echo $loginId?>',<?php echo $counter?>)" href="#">
      <?php echo $row[0]?></a></li>
           <?php
		    $counter++;
            }
	    ...
	    ?> 
      <li>
         <a ng-click="main.getMeetEvents(<?php echo $row[1]?>,'<?php echo $dob?>','<?php echo $sex?>', '<?php echo $loginId?>',<?php echo $counter?>)" id="<?php echo $counter?>" href="#">
      <?php echo $row[0]?></a>
     </li>
      <?php   
           $counter++;
      ...
      ?>
		  ...
		  <div class="cartbtn"><button class="btn" data-toggle="modal" data-target="#myModal"><i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;{{main.length}}</button></div>
	  </div>
      ...
      ?>
        ...
        <div class="meetinfo">  
          <div class="meetinfodata"><span>Swimmer may swim a max {{maxSignUps}} events for the meet, {{maxindividualEvent}} individual and {{maxrelayEvent}} relay per day.</span></div>
          <div class="meetinfosym">Sign up deadline: {{deadline}}</div>
        </div>
          ...
          <div class="table-responsive">          
            <table class="table">
              ...
              <tbody>
                ...
                <td ng-show="item.addButton"><button  class="btn"  ng-click="main.addToCart(item)" id="addbtn"><i class="fa fa-plus-square fa-2x  symbol" aria-hidden="true"></i></button></td>
                <td class="green-text" ng-show="!item.addButton">Selected</td>
              </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="cartInfo"> 
        <div class="cartHeader">
          <p>PAYMENT</p>
			...
			<table>
				<tr>
					<td class="bold">Make checks Payable to: </td><td> {{payableTo}}</td>
				</tr>
				<tr>
					<td class="bold">
						Swimmer Charge: </td><td> {{swimmerCharge| currency}}</td>
				</tr>
				<tr>
					<td class="bold">Per Events Charge: </td><td>{{eventCharges|currency}}</td></tr>
				<tr>
					<td class="bold">Total Amount to be Payed: </td><td>{{total_payment| currency}}
					</td>
				</tr>	
			</table>	
      		    <div class="signup_button">
 			<button class="signup_button" ng-click="view='Events'" onclick="document.getElementById('<?php echo 'my'.$meetCounter;?>').click()">Edit Signups</button>
			</div>
        </div>
	  </div>
    ...
    angular.module('app', []) 
      .controller('mainController', function($scope,$http) {  
		  ...
		  _this.items = [];  
			...
			document.getElementById('page_logout').style.backgroundColor =  'white'; 
			document.getElementById(meetCounter).style.backgroundColor = 'coral';  
            $http({
                method: 'post',
